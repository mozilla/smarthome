...
public class SayConsoleCommandExtension extends AbstractConsoleCommandExtension {
    ...
    protected Voice getPreferedVoice(Set<Voice> voices) {
        ...
        String ranges = locale.getLanguage() + ";q=1.0";
    ...
    protected AudioFormat getPreferedAudioFormat(Set<AudioFormat> audioFormats) {
        ...
        for (AudioFormat currentAudioFormat : formats) {
            ...
            if (null == currentAudioFormat.getBitDepth() || null == currentAudioFormat.getBitRate() || null == currentAudioFormat.getFrequency()) {
                ...
                Integer bitRate = currentAudioFormat.getBitRate();
                Long frequency = currentAudioFormat.getFrequency();
                Integer bitDepth = currentAudioFormat.getBitDepth();
